...
python pretrain.py /NOT/WORKING \
    ...
    --repeated-aug --reprob 0.25 --remode pixel \
    --interpolation bicubic --hflip 0.0 \
    --eval-metric loss --no-prefetcher \
    --interval-saved-epochs 50 --checkpoint-hist 6 --output ${OUT_DIR} \
    --log-wandb
