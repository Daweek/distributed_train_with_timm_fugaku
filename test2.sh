...
# export WORK_DIR=/data/hp190122/users/u01959/distributed_train_with_timm
# export OUT_DIR=$WORK_DIR/checkpoint/${MODEL}/imnet${CLS}k/pre_training
# export NGPUS=8
# export NUM_PROC=8
