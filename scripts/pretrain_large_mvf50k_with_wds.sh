...
#$ -l h_rt=72:00:00
#$ -j y
#$ -o output/pretrain_deit_with_vit_large_mvf50k_lr5e-4_40epochs_bs2048_shard_$JOB_ID.out
...
python pretrain.py /NOT/WORKING \
    ...
    --model vit_${MODEL}_patch16_224 --experiment pretrain_deit_with_vit_${MODEL}_MVfractal${CLS}k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_shards \
    ...
    --resume ${OUT_DIR}/pretrain_deit_with_vit_${MODEL}_MVfractal${CLS}k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_shards/last.pth.tar
