...
#$ -l h_rt=72:00:00
#$ -j y
#$ -o output/pretrain_deit_tiny_mvfdb1k_lr6.0e-4_100epochs_bs1024_render_CPUopenGL_$JOB_ID.out
...
export OUT_DIR=/home/acc12930pb/working/transformer/timm_main_sora/checkpoint/${MODEL}/mvfdb${CLS}k/pre_training
...
python cpurender_pretrain.py /NOT/WORKING \
    ...
    --model deit_${MODEL}_patch16_224 --experiment pretrain_deit_${MODEL}_MVfractal${CLS}k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_render_cpuOpenGL \
