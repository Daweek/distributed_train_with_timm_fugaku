...
#$ -l h_rt=72:00:00
#$ -j y
#$ -o output/pretrain_deit_tiny_mvf10k_lr8e-3_300epochs_bs8192_shards_$JOB_ID.out
...
python pretrain.py /NOT/WORKING \
    ...
    --model deit_${MODEL}_patch16_224 --experiment pretrain_deit_${MODEL}_MVfractal${CLS}k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_shards \
