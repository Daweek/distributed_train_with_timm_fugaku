...
#$ -l h_rt=72:00:00
#$ -j y
#$ -o output/pretrain_deit_base_mvf21k_2k_lr1e-3_90epochs_bs8192_shards_$JOB_ID.out
...
python pretrain.py /NOT/WORKING \
    -w --trainshards "/groups/gcd50691/datasets/MVFractal_Shards_21k_2ki/mvf_21k_2ki-train-{000000..004199}.tar" \
    --model deit_${MODEL}_patch16_224 --experiment pretrain_deit_${MODEL}_MVfractal${CLS}k_2k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_shards \
    ...
    --log-wandb \
    --resume ${OUT_DIR}/pretrain_deit_${MODEL}_MVfractal${CLS}k_2k_lr${LR}_epochs${EPOCHS}_bs${BATCH_SIZE}_shards/last.pth.tar
